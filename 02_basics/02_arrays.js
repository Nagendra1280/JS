...
//Array.isArray(): returns true or false based on passe
...
console.log(Array.from({name: "Hitesh" , age: 24}));//[] 
//interesting case (here we have to specify we want array based on keys or values, otherwise it will return empty array.)
//Array.of()
