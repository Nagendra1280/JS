...
/*Note: this is not a number but still js convert it in
to a number. Its type will be number, but value will be 
"NaN". So whenever you convert string to number always 
check for this NaN case.*/
...
console.log(booleanLoggedIn1);// true
