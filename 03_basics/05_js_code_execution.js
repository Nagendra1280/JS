...
5. Execution phase - In this phase, the variables are i
nitialised to given values and 
  when the functions are called, it creates a memory ph
ase and execution phase for the function 
